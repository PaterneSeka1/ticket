      ...
      <div className="space-y-4 lg:hidden max-w-[420px] mx-auto w-full">
        {mobileRows.length === 0 ? (
          ...
          mobileRows.map((ticket) => {
            ...
            return (
              <article key={ticket.id} className="rounded-[18px] border border-[#eee3d6] bg-white p-4 shadow-[0_10px_30px_rgba(17,17,17,0.08)]">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex justify-between">
                    <span className="text-[12px] text-[#7b6655]">Date: {formatDateTime(ticket.detectedAt ?? ticket.createdAt)}</span>
                    <button
                      type="button"
